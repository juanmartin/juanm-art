...
<div className="md:flex flex-row" >
    <Img fluid={props.embeddedImages.image1.fluid} alt="Modular Login Screenshot" className="w-full mr-5" />
    <Img fluid={props.embeddedImages.image2.fluid} alt="Modular Login Screenshot" className="w-full " />
</div>

...
<div className="md:flex flex-row" >
    <GatsbyImage image={getImage(props.embeddedImages.image1)} alt="Modular Login Screenshot" className="w-full mr-5 mb-2" />
    <GatsbyImage image={getImage(props.embeddedImages.image2)} alt="Modular Login Screenshot 2" className="w-full mb-2" />
</div>

...
## EDIT:
It didn't actually work at first. I even posted [a question](https://stackoverflow.com/questions/64657572/production-gatsby-blog-not-rendering-tailwindcss-classes-in-mdx-files) in StackOverflow but it was closed due to lack of clarity... =(

...
Soy un joven sensible entusiasta de la técnica. Aplicado a las artes y la tecnología. Desarrollo **soluciones tecnológicas** utilizando diversas herramientas desde la programación y el hardware. También **produzco mi música**.
...
> Este sitio es un **Work in Progress** y lo va a ser por siempre. Voy a ir sumando contenido. Juntar toooda la data de lo que fui haciendo no va a ser fácil, creo que es un camino. **Me va a hacer bien, ya lo siento. Recomiendo**.
